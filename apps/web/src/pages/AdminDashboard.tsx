                        ...
                        >
                          ...
                          <td className="px-3 sm:px-4 py-3 text-sm text-slate-500 dark:text-slate-400 truncate max-w-[200px]">
                            {ch.type === 'email'
                              ...
                              : (ch.config_json as WebhookChannelConfig).preset === 'telegram'
                              ? `${t('notification_form.preset_telegram')}: ${(ch.config_json as TelegramChannelConfig).chat_id}`
                              : (ch.config_json as CustomWebhookChannelConfig).url}
                          </td>
                          <td className="px-3 sm:px-4 py-3 text-right whitespace-nowrap">
                            <div className="flex items-center justify-end gap-1 sm:gap-0">
                              <button
