...
import { customWebhookChannelConfigSchema, emailChannelConfigSchema } from '@uptimer/db';
...
export const patchNotificationChannelInputSchema = z
  .object({
    ...
    config_json: z
      .union([customWebhookChannelConfigSchema, telegramChannelPatchInputSchema, emailChannelConfigSchema])
      .optional(),
    is_active: z.boolean().optional(),
  })
